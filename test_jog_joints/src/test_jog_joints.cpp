...
int main(int argc, char** argv) 
{
    ...
    while(jnt>=0) {
        ...
        */
        ...
        ROS_INFO("just kidding--not enabled to publish yet");
        ros::spinOnce();
        cout << "arm is at: " << g_q_vec_arm_Xd.transpose() << endl;        
    }
    ...
    new_trajectory.joint_names.push_back("joint_1_s");
    new_trajectory.joint_names.push_back("joint_2_l");
    new_trajectory.joint_names.push_back("joint_3_u");
    new_trajectory.joint_names.push_back("joint_4_r");
    new_trajectory.joint_names.push_back("joint_5_b");
    new_trajectory.joint_names.push_back("joint_6_t");    
