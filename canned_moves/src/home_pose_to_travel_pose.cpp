//home_pose_to_travel_pose.cpp
//wsn, 7/13/18
// node specialized to move robot from DH home pose to hard-coded travel pose while keeping wrist low
// robot must be initially close to home pose, or this node will simply quit
